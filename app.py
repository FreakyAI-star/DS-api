...
clm_admit_diagnosis_code = transform_diagnosis_code(clm_admit_diagnosis_code, 'label_encoder_ClmAdmitDiagnosisCode.pkl')
clm_diagnosis_code_1 = transform_diagnosis_code(clm_diagnosis_code_1, 'label_encoder_ClmDiagnosisCode_1.pkl')
clm_diagnosis_code_2 = transform_diagnosis_code(clm_diagnosis_code_2, 'label_encoder_ClmDiagnosisCode_2.pkl')
clm_diagnosis_code_3 = transform_diagnosis_code(clm_diagnosis_code_3, 'label_encoder_ClmDiagnosisCode_3.pkl')
clm_diagnosis_code_4 = transform_diagnosis_code(clm_diagnosis_code_4, 'label_encoder_ClmDiagnosisCode_4.pkl')
clm_diagnosis_code_5 = transform_diagnosis_code(clm_diagnosis_code_5, 'label_encoder_ClmDiagnosisCode_5.pkl')
clm_diagnosis_code_6 = transform_diagnosis_code(clm_diagnosis_code_6, 'label_encoder_ClmDiagnosisCode_6.pkl')
clm_diagnosis_code_7 = transform_diagnosis_code(clm_diagnosis_code_7, 'label_encoder_ClmDiagnosisCode_7.pkl')
clm_diagnosis_code_8 = transform_diagnosis_code(clm_diagnosis_code_8, 'label_encoder_ClmDiagnosisCode_8.pkl')
clm_diagnosis_code_9 = transform_diagnosis_code(clm_diagnosis_code_9, 'label_encoder_ClmDiagnosisCode_9.pkl')
clm_diagnosis_code_10 = transform_diagnosis_code(clm_diagnosis_code_10, 'label_encoder_ClmDiagnosisCode_10.pkl')
...
provider = transform_diagnosis_code(provider, 'label_encoder_Provider.pkl')
